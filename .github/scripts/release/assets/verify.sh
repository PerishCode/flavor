...
ensure_tar_contains("flavor-x86_64-unknown-linux-gnu.tar.gz", "flavor")
ensure_tar_contains("flavor-aarch64-apple-darwin.tar.gz", "flavor")
ensure_tar_contains("flavor-x86_64-apple-darwin.tar.gz", "flavor")
ensure_zip_contains("flavor-x86_64-pc-windows-msvc.zip", "flavor.exe")
PY
}
...
case "$MODE" in
  accept)
    ...
    require_file flavor-x86_64-unknown-linux-gnu.tar.gz
    require_file flavor-aarch64-apple-darwin.tar.gz
    require_file flavor-x86_64-apple-darwin.tar.gz
    require_file flavor-x86_64-pc-windows-msvc.zip
    ...
    for asset in \
      flavor-x86_64-unknown-linux-gnu.tar.gz \
      flavor-aarch64-apple-darwin.tar.gz \
      flavor-x86_64-apple-darwin.tar.gz \
      flavor-x86_64-pc-windows-msvc.zip
    do
