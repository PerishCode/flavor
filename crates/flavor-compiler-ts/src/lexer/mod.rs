...
use flavor_compiler_core::{SourceText, Span, Token, Trivia, TriviaKind};

use crate::{state::TsCompilerConfig, syntax_kind::TsSyntaxKind};
...
pub fn scan(source: &SourceText, _config: &TsCompilerConfig) -> Vec<Token<TsSyntaxKind>> {
