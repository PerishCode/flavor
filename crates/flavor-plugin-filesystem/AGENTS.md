...
`crates/flavor-plugin-filesystem/` owns first-party filesystem/path-shape plugin
...
- Rule semantics stay about path and direct-child shape, not product-specific
  business concepts.
